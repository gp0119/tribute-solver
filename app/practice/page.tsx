    ...
    <main className='app-shell practice-shell'>
      <header className='topbar'>
        ...
        <div className='header-actions'>
          <nav className='page-nav' aria-label='页面导航'>
            ...
            <Link className='page-link active' href='/practice'>
              做题
            </Link>
          </nav>
          <button type='button' className='quiet-button' onClick={newQuestion}>
            换一题
          </button>
        </div>
      </header>
      ...
      <section className='rules-card' aria-labelledby='rules-title'>
        ...
        <ul>
          ...
          <li>
            <b className='result-icon exact' aria-hidden='true'>
              ◎
            </b>{' '}
            表示“颜色和位置都正确”的数量。
          </li>
          <li>
            <b className='result-icon misplaced' aria-hidden='true'>
              ◉
            </b>{' '}
            表示“颜色正确但位置错误”的数量。
          </li>
      ...
      <section className='history-section practice-history' aria-labelledby='practice-history-title'>
        <div className='history-heading'>
          <div>
            <h2 id='practice-history-title'>猜测结果</h2>
          </div>
      ...
      <section className='panel practice-panel' aria-labelledby='practice-title'>
        <div className='panel-heading practice-heading'>
          <div>
            <h2 id='practice-title'>第 {attempts.length + 1} 次猜测</h2>
        ...
        {finished ? (
          <div className={solved ? 'practice-finish solved' : 'practice-finish revealed'}>
            ...
            <button type='button' className='secondary-button' onClick={newQuestion}>
              开始下一题
            </button>
          </div>
        ) : (
